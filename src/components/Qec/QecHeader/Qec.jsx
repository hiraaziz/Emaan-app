...
import "./Qec.css";
import QecDirector from "../QecDirector/QecDirector";
            ...
            <div class="Qec-points-container">
              <div class="Qec-point-box" ref={(el) => observer.observe(el)}>
                <p class="Qec-point">
                  ...
                  important creativity taken by the{" "}
                  <span className="light-red ">
                    Higher Education Comission (HEC)
                  </span>
                  , of Pakistan for the improvement of quality of higher
              ...
              <div class="Qec-point-box" ref={(el) => observer.observe(el)}>
                <p class="Qec-point">
                  ...
                  <span className="WhiteBold">
                    The Quality Enhancement Cell (QEC)
                  </span>{" "}
                  is established in Emaan Institute of Management & Science
                  Karachi in 2020.
                </p>
              </div>
              <div class="Qec-point-box" ref={(el) => observer.observe(el)}>
