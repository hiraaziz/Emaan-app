...
const Aboutus = () => {
  ...
  <div class="wel-container">
    ...
    <div class="welcomered-underline"></div>

    <p class="welcome-paragraph">EMAAN INSTITUTE OF MANAGEMENT & SCIENCES (EIMS) has been established via Sindh Act No: XXXV of 2018 and recognized by HEC (Higher Education Commission) as Degree Awarding Institute. EMAAN INSTITUTE OF MANAGEMENT & SCIENCES (EIMS) has been established for creating leaders and developing the best professionals in every arena of life. It is our motto to impart the best quality education to the people of Pakistan. We have determined to play a pivotal role in rebuilding the educational foundations of our country on the basis of following visionary principles;
    CHARTERED BY GOVERNMENT OF SINDH, RECOGNIZED BY HEC (HIGHER EDUCATION COMMISSION)
    We offer a wide range of high quality of teaching and extra-curricular activities.Providing state-of-the-art campus building in order to create congenial academic environment.
    ...
    Bridging the gap between the Corporate Sector and the Educational Institutes/Universities so that education of relevance can be provided in order to cater to the national as well as international needs..</p>
  </div>
</section>
