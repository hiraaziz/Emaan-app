...
const Vision = () => {
  return (
    <section className="flex justify-center items-center w-full bg-slate-50 py-20">
      ...
      <div className="bg-maroon h-96 w-px rounded-full"></div>

      <div className="flex flex-col w-400 px-8 space-y-8">
